...
class CardServiceTest {
    ...
    void readsPassengerCardsFromRedisWithoutDatabasePersistence() throws Exception {
        ...
        List<CardResponse> result = new CardService(redis, mapper, level5Client, 600)
    ...
    void loadsAndCachesCardsFromLevel5WhenHistoryWasNotLoaded() {
        ...
        assertThat(result).extracting(CardResponse::getExternalCardId).containsExactly("card-1");
